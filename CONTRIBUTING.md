...
First, it is awesome that you are considering contributing to MLSC's IRC project! Contributing is important and fun and we welcome your efforts.
...
Please follow the intructions mentioned in the [README.md](README.md) file
...
3. Open Pull Request to the `dev` branch.
4. All your commits must be signed.
